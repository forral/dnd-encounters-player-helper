...
function addPartyForm() {
	...
	const form = helperModule.templateAddCharacterForm(FORM_CONFIG_PARTY);
...
function handleEventListeners() {
	...
	tablinks.forEach(function(element) {
		element.addEventListener("click", function(event) {
			...
			let tabPartyContentElement = document.querySelector(
				"#party-tab-content"
			);
			let tabEnemyContentElement = document.querySelector(
				"#enemy-tab-content"
			);
